$(document).ready(function () {
  ...
  var securityModal = $(".security"),
    ...
    securityModalBtn = $(".security__button");
  ...
  var trainingModal = $(".training"),
    ...
    trainingModalBtn = $(".training__button");
  ...
  var preparationModal = $(".preparation"),
    ...
    preparationModalBtn = $(".preparation__button");
  ...
  var uniquenessnModal = $(".uniqueness"),
    uniquenessCloseBtn = $(".uniqueness__close"),
    uniquenessModalBtn = $(".uniqueness__button");

  uniquenessModalBtn.on("click", function () {
    uniquenessnModal.toggleClass("uniqueness--visible");
    $("body").addClass("lock");
  });
  ...
  $(document).click(function (e) {
    if ($(e.target).is(uniquenessnModal)) {
      uniquenessnModal.toggleClass("uniqueness--visible");
      $("body").removeClass("lock");
    }
  });
